        ...
        <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="project" value="{{$property->project}}" required>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="gallery-box">
                        ...
                        <button type="button" class="btn btn-info btn-lg right" id="galleryuploadbutton">UPLOAD THÊM ẢNH</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('purpose') ? 'focused error' : ''}}">
                            ...
                            <select name="purpose" class="form-control show-tick">
                                ...
                                <option value="Bán" {{ $property->purpose=='Bán' ? 'selected' : '' }}>Bán</option>
                                <option value="Cho thuê" {{ $property->purpose=='Cho thuê' ? 'selected' : '' }}>Cho thuê</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('type') ? 'focused error' : ''}}">
                            ...
                            <select name="type" class="form-control show-tick">
                                <option value="">-- Mời lựa chọn --</option>
                                <option value="Nhà đất" {{ $property->type=='Nhà đất' ? 'selected' : '' }}>Nhà đất</option>
                                <option value="Căn hộ" {{ $property->type=='Căn hộ' ? 'selected' : '' }}>Căn hộ</option>
                            </select>
                        </div>
                    </div>
