...
@section('content')
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">Bất động sản nổi bật</h4>
            </div>
            <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content property-content">
                                ...
                                <div class="address">
                                    ...
                                    <span> {{ $property->purpose }}: {{ ucfirst($property->type) }}</span>
                                </div>
    ...
    <section class="section center">
        <div class="row">
            <h4 class="section-heading">Tin tức mới</h4>
        </div>
        <div class="container">
            <div class="row">
    ...
    <section class="section grey lighten-3 center">
        <div class="container">
            ...
            <h4 class="section-heading">Nhận xét của khách hàng</h4>
