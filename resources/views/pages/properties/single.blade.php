            ...
            <div class="row">
                <div class="col s12 m8">
                    ...
                    <div>
                        ...
                        <span class="btn btn-small disabled b-r-20">Diện tích: {{ $property->area}} m2</span>
                    </div>
                </div>
                <div class="col s12 m4">
                    <div>
                        <h4 class="left">{{ $property->price }}đ</h4>
                        <button type="button" class="btn btn-small m-t-25 right disabled b-r-20"> Đang {{ $property->purpose }}</button>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div>
                        @if($property->features)
                            <ul class="collection with-header">
                                <li class="collection-header grey lighten-4"><h5 class="m-0">Điểm nổi bật</h5></li>
                        ...
                        <div>
                            <ul class="collection with-header m-t-0">
                                <li class="collection-header grey lighten-4">
                                    <h5 class="m-0">Liên hệ với nhà môi giới</h5>
                                </li>
                        ...
                        <div>
                            <ul class="collection with-header">
                                ...
                                @foreach($projects as $project)
                                    <li class="collection-item p-0">
                                        <a class="city-list" href="{{ route('property.project',$project->project_slug) }}">
            ...
            .on("rateyo.set", function (e, data) {
                ...
                $.post( "{{ route('property.rating') }}", { rating: rating, property_id: property_id, user_id: user_id }, function( data ) {
                    if(data.rating.rating){
                        M.toast({html: 'Đánh giá: '+ data.rating.rating + ' sao thêm thành công.', classes:'green darken-4'})
                    }
                });
            });
