                ...
                <div class="col s12 m4">
                    <div class="contact-sidebar">
                        <div class="m-t-30">
                            ...
                            <h6 class="uppercase">điện thoại:</h6>
            ...
            $(document).on('submit','#contact-us',function(e){
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $(btn).empty().append('<span>Đang gửi...</span><i class="material-icons right">rotate_right</i>');
                    },
                    ...
                    error: function(xhr) {
                        M.toast({html: 'Thông báo: Đã gửi thành công!', classes: 'green darken-4'})
                        // M.toast({html: data.message, classes:'green darken-4'})
                    },
                    complete: function() {
                        $('form#contact-us')[0].reset();
                        $(btn).removeClass('disabled');
                        $(btn).empty().append('<span>GỬI</span><i class="material-icons right">send</i>');
                    },
                    dataType: 'json'
                });
