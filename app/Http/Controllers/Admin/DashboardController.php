...
class DashboardController extends Controller
{
    ...
    public function settingStore(Request $request)
    {
        ...
        Toastr::success('message', 'Cài đặt thành công.');
        return back();
    }
    ...
    public function changePasswordUpdate(Request $request)
    {
        if (!(Hash::check($request->get('currentpassword'), Auth::user()->password))) {
            ...
            Toastr::error('Thông báo', 'Mật khẩu bạn nhập vào chưa đúng, xin hãy thử lại.');
            return redirect()->back();
        }
        if(strcmp($request->get('currentpassword'), $request->get('newpassword')) == 0){

            Toastr::error('Thông báo', 'Mật khẩu mới phải khác mật khẩu cũ, xin hãy thử lại.');
            return redirect()->back();
        }
    ...
    public function messageSend(Request $request)
    {
        ...
        Toastr::success('Thông báo', 'Gửi tin nhắn thành công.');
        return back();
    ...
    public function messageDelete($id)
    {
        ...
        Toastr::success('Thông báo', 'Xóa tin nhắn thành công.');
        return back();
    }
    ...
    public function contactMail(Request $request)
    {
        ...
        Toastr::success('Thông báo', 'Mail gửi thành công.');
        return back();
    }
}
