...
class DashboardController extends Controller
{
    ...
    public function changePasswordUpdate(Request $request)
    {
        if (!(Hash::check($request->get('currentpassword'), Auth::user()->password))) {
            ...
            Toastr::error('Thông báo', 'Bạn nhập mật khẩu sai, xin hãy thử lại.');
            return redirect()->back();
        }
        if(strcmp($request->get('currentpassword'), $request->get('newpassword')) == 0){

            Toastr::error('Thông báo', 'Mật khẩu mới không được trùng với mật khẩu cũ, xin hãy thử lại.');
            return redirect()->back();
        }
        ...
        Toastr::success('Thông báo', 'Thay mật khẩu thành công.');
        return redirect()->back();
    }
    ...
    public function messageSend(Request $request)
    {
        ...
        Toastr::success('message', 'Gửi tin nhắn thành công.');
        return back();
    ...
    public function messageDelete($id)
    {
        ...
        Toastr::success('message', 'Xóa tin nhắn thành công.');
        return back();
    }
    ...
    public function contactMail(Request $request)
    {
        ...
        Toastr::success('message', 'Gửi mail thành công.');
        return back();
    }
