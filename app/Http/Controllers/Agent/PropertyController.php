...
class PropertyController extends Controller
{
    ...
    { 
        ...
        $property->project_slug= str_slug($request->project);
        ...
        Toastr::success('Thông báo', 'Thêm bất động sản thành công.');
    ...
    {   
        ...
        Toastr::success('Thông báo', 'Sửa bất động sản thành công.');
        return redirect()->route('agent.properties.index');
    }
    ...
    public function destroy(Property $property)
    {
        ...
        Toastr::success('Thông báo', 'Xóa bất động sản thành công.');
        return back();
    }
