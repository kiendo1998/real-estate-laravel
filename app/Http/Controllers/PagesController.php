...
class PagesController extends Controller
{
    ...
    {
        $projects     = Property::select('project','project_slug')->distinct('project_slug')->get();
        $properties = Property::latest()->with('rating')->withCount('comments')->paginate(12);

        return view('pages.properties.property', compact('properties','projects'));
    }
    ...
    public function propertieshow($slug)
    {
        ...
        return view('pages.properties.single', compact('property','rating','relatedproperty','videoembed','projects'));
    }
    ...
    // xu ly sau khi click tren navbar
    ...
    public function blogshow($slug)
    {
        ...
        //dat key blog-id vao session cua nguoi dung, neu chua co thì view tăng lên
    ...
    // gui tin nhan cho agent(SINGLE AGENT PAGE)
    ...
    public function messageContact(Request $request)
    {
        ...
        if($request->ajax()){
            return response()->json(['Thông báo' => 'Gửi tin nhắn thành công.']);
        }
    ...
    public function propertyProjects()
    {
        ...
        $properties = Property::latest()->with('rating')->withCount('comments')
                        ->where('project_slug', request('projectslug'))
                        ->paginate(12);
